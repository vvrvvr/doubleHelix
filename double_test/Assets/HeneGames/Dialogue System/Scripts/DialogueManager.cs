...
namespace HeneGames.DialogueSystem
{
    public class DialogueManager : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (Input.GetKeyDown(_dialogueUI.actionInput) && dialogueTrigger != null && !dialogueIsOn)
            {
                ...
                _dialogueUI.StartDialogue(this);

                //Hide interaction UI
                _dialogueUI.ShowInteractionUI(false);
        ...
        private void OnTriggerStay(Collider other)
        {
            ...
            if (triggerState == TriggerState.Input && dialogueTrigger == null)
            {
                ...
                {
                    //Show interaction UI
                    _dialogueUI.ShowInteractionUI(true);
        ...
        private void ShowCurrentSentence()
        {
            if (sentences[currentSentence].dialogueCharacter != null)
            {
                ...
                _dialogueUI.ShowSentence(sentences[currentSentence].dialogueCharacter, sentences[currentSentence].sentence);
            ...
            else
            {
                ...
                _dialogueUI.ShowSentence(_dialogueCharacter, sentences[currentSentence].sentence);
            }
        }
    }
